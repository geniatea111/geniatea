...
import com.example.compose.geniatea.conversation.ConversationContent
import com.example.compose.geniatea.conversation.ConversationTestTag
import com.example.compose.geniatea.conversation.ConversationUiState
import com.example.compose.geniatea.data.exampleUiState
...
class ConversationTest {
    ...
    fun setUp() {
        ...
        composeTestRule.setContent {
            GenIATEATheme(isDarkTheme = themeIsDark.collectAsStateWithLifecycle(false).value) {
                ConversationContent(

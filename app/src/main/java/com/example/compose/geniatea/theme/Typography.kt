...
val DMSansFont = FontFamily(
    Font(resId = R.font.dm_sans_variable),
    Font(resId = R.font.dm_sans_bold, weight = FontWeight.Bold),
    Font(resId = R.font.dm_sans_extra_bold, weight = FontWeight.ExtraBold),
)

//from rest/font/giphus.ttf
val DtGetaiFont = FontFamily(
    Font(resId = R.font.dt_getai, weight = FontWeight.Bold),
)

val titleApp = TextStyle(
    fontFamily = DtGetaiFont,
    fontWeight = FontWeight.SemiBold,
    fontSize = 20.sp,
    letterSpacing = 0.15.sp,
)

val subtitleApp = TextStyle(
    fontFamily = DtGetaiFont,
...
val DtGetaiTypography = Typography(
...
val GenIATEATypography = Typography(
